...
import { clearItems, ItemType } from 'store/slices/cartSlice';

export const Cart = () => {
  const items = useSelector<RootStateType, ItemType[]>(state => state.cart.items);
  const totalPrice = useSelector<RootStateType, number>(state => state.cart.totalPrice);
